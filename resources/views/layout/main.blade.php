...
<html dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo asset('css/my.css') ?>">
    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            <span class="hi">{{trans('file.Dashboard')}}</span>
            <li><a href="{{url('/')}}"> <i class="dripicons-meter"></i><span>{{ __('file.dashboard') }}</span></a></li>
            <span class="hi">{{trans('file.General')}}</span>
            <?php
            ...
            <span class="hi">{{trans('file.BUSINESS')}}</span>
            </li>
            @endif
            <?php
                $index_permission_active = DB::table('permissions')
            ...
            <span class="hi">{{trans('file.Management')}}</span>
            ...
            @endif
            <span class="hi">{{trans('file.Extra')}}</span>
            ...
            @if(Auth::user()->role_id != 5)
            <li><a target="_blank" href="{{url('public/read_me')}}"> <i class="dripicons-information"></i><span>{{trans('file.Offer')}}</span></a></li>
            @endif
        </ul>
    ...
    <div class="page">
           ...
           <!-- @if(\Auth::user()->role_id <= 2)
            ...
            <li class="nav-item">
                    ...
                    <ul class="right-sidebar">
                        ...
                        <li>
                        <a href="{{ url('language_switch/hi') }}" class="btn btn-link"> বাংলা</a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <ul class="right-sidebar">
                    ...
                    @endif
                    //User Er Eto Kichur kono dorkar nai ,besi dile besi loss-->
                    <li>
                 ...
                 <!--
                    ...
                    //Permission Delete kora hoise, tarpor kaj korchilo-->
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <span class="external">{{$general_setting->developed_by}}</span> | Call 01789180189 For Free Demo.</p>
            </div>
          </div>
        </div>
      </footer>
